...
| <img src="https://github.githubassets.com/images/modules/profile/achievements/arctic-code-vault-contributor-default.png" alt="GitHub-бейджик за достижение Arctic Code Vault Contributor" style="width:80px"> | **Arctic Code Vault Contributor** | Contributed code to a repository in the [2020 GitHub Archive Program](https://archiveprogram.github.com/) | Выдавалось за единичный случай вклада (*больше нельзя заработать*) |
